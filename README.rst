...
This plugin adds named pipe client functions in Kirikiri2 / 吉里吉里2 /
KirikiriZ / 吉里吉里Z
...
``krnamedpipeclient.dll``.

How to use
----------

After ``Plugins.link("krnamedpipeclient.dll");`` is used, the additional
functions will be exposed under the ``NamedPipeClient`` class.
